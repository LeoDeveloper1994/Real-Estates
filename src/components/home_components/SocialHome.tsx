...
const SocialHome = () => {
  return (
    <figure className="home-social-container">
      <p>SIGUENOS EN</p>
      <h1>
        REDES <span>SOCIALES</span>
      </h1>
      <figcaption>
        ¡Quieres estar actualizado! Síganos en las redes sociales para conocer las noticias y promociones inmobiliarias
        más exclusivas de nuestro increíble portafolio de listados.
      </figcaption>
      <div className="insta-galery">
        <a href="https://www.instagram.com/williamcervanteseyssautier/" target="_blanck" className="galery-item-1 item">
        ...
        <a href="https://www.instagram.com/valeriacervateseyssautier/" target="_blanck" className="galery-item-5 item">
          <i className="fa-brands fa-instagram"></i>
          <p>@val_eyss</p>
        </a>
        <a
      ...
      <div className="home-social-img-container">
        <div className="home-social-logo-container">
        ...
        <hr />
        <div className="home-social-quickly">
          <p>TELEFONO:</p>
          <p>449.165.9373</p>
          <p>EMAIL:</p>
